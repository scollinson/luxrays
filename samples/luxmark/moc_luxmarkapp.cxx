...
void LuxMarkApp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        LuxMarkApp *_t = static_cast<LuxMarkApp *>(_o);
        switch (_id) {
        case 0: _t->RenderRefreshTimeout(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData LuxMarkApp::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject LuxMarkApp::staticMetaObject = {
    { &QApplication::staticMetaObject, qt_meta_stringdata_LuxMarkApp,
      qt_meta_data_LuxMarkApp, &staticMetaObjectExtraData }
};
